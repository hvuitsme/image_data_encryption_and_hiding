...
# label_image = tk.Label(frame, text="Đường dẫn ảnh:")
# label_image.grid(row=0, column=0, sticky="w")

# entry_image = tk.Entry(frame, width=50)
# entry_image.grid(row=0, column=1)

# button_browse = tk.Button(frame, text="Chọn ảnh", command=browse_image)
# button_browse.grid(row=0, column=2)

# label_image_display = tk.Label(frame)
# label_image_display.grid(row=1, column=0, columnspan=3)  # Hiển thị ảnh ở hàng thứ nhất, cột thứ 0 với chiều rộng 3 cột

# label_text = tk.Label(frame, text="Văn bản cần giấu:")
# label_text.grid(row=2, column=0, sticky="w")

# entry_text = tk.Entry(frame, width=50)
# entry_text.grid(row=2, column=1)

# button_encode = tk.Button(frame, text="Mã hoá và giấu dữ liệu", command=encode_and_hide)
# button_encode.grid(row=3, column=0)

# button_decode = tk.Button(frame, text="Trích xuất và hiển thị dữ liệu", command=decode_and_show)
# button_decode.grid(row=3, column=1)
...
# label_image_display = tk.Label(right_frame)
